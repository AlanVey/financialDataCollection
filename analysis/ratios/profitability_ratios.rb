def profitability_ratios(data)
  ...
  if data["revenue"] != nil
    ...
    prof_data[0] = data["gross_profit"][0]/revenue     if data["gross_profit"] != nil
    prof_data[1] = data["operating_profit"][0]/revenue if data["operating_profit"] != nil
    prof_data[2] = data["net_profit"][0]/revenue       if data["net_profit"] != nil
  end
  
  if data["income_tax"] != nil and data["pre_tax_income"] != nil
    prof_data[3] = data["income_tax_expense"][0]/data["pre_tax_income"][0]
  end
  ...
  if data["assets"] != nil
    ...
    if data["net_assets"] != nil
      prof_data[4] = return_on_assets(data["net_assets"][0], data["assets"][1], assets)
    end

    if data["operating_profit"] != nil and data["current_liabilities"] != nil
      ebit                = data["operating_profit"][0]
...
def return_on_capital(ebit, assets, current_liabilities)
  ebit/(assets - current_liabilities)
end