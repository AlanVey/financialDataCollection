...
require_relative 'ratios/performance_ratios'
...
def extract_data(path)
	...
	extracted_data = {}
	figures_needed = ["ASSETSCURRENT", "LIABILITIESCURRENT", "INVENTORYNET", "RECEIVABLESNETCURRENT",
										"ACCOUNTSPAYABLECURRENT", "ASSETS", "LIABILITIESANDSTOCKHOLDERSEQUITY",
										"LONGTERMDEBTANDCAPITALLEASEOBLIGATIONS", "LIABILITIES", "DEBTCURRENT",
										"PROPERTYPLANTANDEQUIPMENTNET", "OPERATINGINCOMELOSS", "COSTOFGOODSSOLD",
										"NETCASHPROVIDEDBYUSEDINCONTINUINGOPERATIONS", "COSTOFGOODSANDSERVICESSOLD",
										"REVENUES", "SALESREVENUENET", "GROSSPROFIT", "OPERATINGINCOMELOSS",
										"INCOMETAXEXPENSEBENEFIT", "NETINCOMELOSS", "OPERATINGINCOMELOSS",
										"INCOMELOSSFROMCONTINUINGOPERATIONSINCLUDINGPORTIONATTRIBUTABLETONONCONTROLLINGINTEREST",
										"ACCUMULATEDDEPRECIATIONDEPLETIONANDAMORTIZATIONPROPERTYPLANTANDEQUIPMENT",
										"PAYMENTSTOACQUIREPROPERTYPLANTANDEQUIPMENT", "PROPERTYPLANTANDEQUIPMENTGROSS",
										"DEPRECIATIONANDAMORTIZATION", "EARNINGSPERSHAREBASIC", "EARNINGSPERSHAREDILUTED"]
